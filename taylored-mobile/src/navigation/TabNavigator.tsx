...
export default function TabNavigator() {
  return (
    <Tab.Navigator
      screenOptions={{
        headerShown: false,
        tabBarStyle: { backgroundColor: '#000', borderTopWidth: 0, height: 60, paddingBottom: 10, paddingTop: 10 },
    ...
    >
      ...
      <Tab.Screen name="Apps" component={AppsScreen} options={{ tabBarIcon: ({ color, size }) => <Grid color={color} size={size} /> }} />
