...
if (!fs.existsSync(SOURCE)) {
  console.warn('[optimize-owr-library-video] Source not found, skipping:', SOURCE);
  process.exit(0);
}
...
try {
  ...
  console.log('[optimize-owr-library-video] ffmpeg missing — copied source to public/');
  process.exit(0);
}
...
console.log('[optimize-owr-library-video] Done:', OUT);
