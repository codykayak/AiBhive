#!/usr/bin/env node
/** Upload public/plants-mobile-releases.json to Firebase Storage (public read). */
...
const manifestRef = ref(storage, 'mobile/plants-mobile-releases.json');
...
console.log('FIREBASE_PLANTS_MANIFEST_URL=' + manifestUrl);
