...
const STEPS: TourStep[] = [
  {
    ...
    title: 'AiBhive Apps hub',
    body: 'Your home base on the web — Do, Build, and Research with Bhive Builder.',
    icon: LayoutGrid,
    path: '/app',
  },
  {
    ...
    body: 'Run free OSINT on companies, domains, or people. AI filters raw data into a readable brief.',
    icon: Radar,
    path: '/app/research',
  },
  {
    ...
    body: 'Describe any app in plain English. Approve the quote and Bhive Builder builds it in the browser.',
    icon: Wand2,
  ...
  },
  {
    ...
    title: 'Bhive Builder (always here)',
    body: 'On research and app pages Bhive Builder pins to the top so you can keep building while you work.',
    icon: Bot,
  },
];
