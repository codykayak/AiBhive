...
export default function GetStarted() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const cleanMessage = msg.replace(/^Error:\s*/i, '');
            ...
            >
              ...
              {files.length > 0 ? (
                ...
                <>
                  ...
                  <p className="text-slate-500 mt-1 text-sm">Audio, video, or text (max 50MB per file)</p>
                </>
              )}
            </label>
          </section>
