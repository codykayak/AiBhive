...
const WELCOME =
  "I'm Bhive Builder — your Research Lab copilot. Ask me to customize tools, refine archive searches, chain Fable Scrape → OCR → RAG, or build custom research apps.";
