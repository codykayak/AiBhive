...
import GreenTeamEmbedPage from './pages/GreenTeamEmbedPage';
import AcademyPage, { GreenTeamAcademyRedirect } from './pages/AcademyPage';
import BugBountiesEmbedPage from './pages/BugBountiesEmbedPage';
import AiMoneyEmbedPage from './pages/AiMoneyEmbedPage';
...
const AiDevelopmentServicesPage = lazy(() => import('./pages/AiDevelopmentServicesPage'));
...
const AibhiveOnLandingPage = lazy(() => import('./pages/aibhive-on/AibhiveOnLandingPage'));
const AibhiveOnDashboardPage = lazy(() => import('./pages/aibhive-on/AibhiveOnDashboardPage'));
const AibhiveOnSettingsPage = lazy(() => import('./pages/aibhive-on/AibhiveOnSettingsPage'));
const AibhiveOnDownloadPage = lazy(() => import('./pages/aibhive-on/AibhiveOnDownloadPage'));
...
const ForAiAgentsPage = lazy(() => import('./pages/tools/ForAiAgentsPage'));
...
const AutoimmunePage = lazy(() => import('./pages/plants/AutoimmunePage'));
...
const DiagnoseWebConstructionChart = lazy(() => import('./pages/diagnose-web/charts/DiagnoseWebConstructionChart'));
...
function AnimatedRoutes() {
  ...
  const isEmbedShell =
    location.pathname.startsWith('/embed/green-team') ||
    location.pathname.startsWith('/embed/bug-bounties') ||
    location.pathname.startsWith('/embed/ai-money') ||
    location.pathname.startsWith('/greenteam-embed/');

  const routeTree = (
    <Suspense fallback={isEmbedShell ? null : <PageLoader />}>
      <Routes location={location}>
            <Route path="/" element={<Home />} />
            <Route path="/academy" element={<AcademyPage />} />
            <Route path="/green-team" element={<GreenTeamAcademyRedirect />} />
            <Route path="/embed/green-team" element={<GreenTeamEmbedPage />} />
            <Route path="/greenteam-embed/embed/green-team" element={<GreenTeamEmbedPage />} />
            <Route path="/embed/bug-bounties" element={<BugBountiesEmbedPage />} />
            <Route path="/greenteam-embed/embed/bug-bounties" element={<BugBountiesEmbedPage />} />
            <Route path="/embed/ai-money" element={<AiMoneyEmbedPage />} />
            <Route path="/greenteam-embed/embed/ai-money" element={<AiMoneyEmbedPage />} />
            ...
            <Route path="/tools/for-ai-agents" element={<ForAiAgentsPage />} />
            <Route path="/tools/real-estate-ai" element={<RealEstateAiToolsPage />} />
            <Route path="/get-started" element={<GetStarted />} />
            <Route path="/admin" element={<AdminDashboard />} />
            <Route path="/aibhive-on" element={<AibhiveOnLandingPage />} />
            <Route path="/aibhive-on/app" element={<AibhiveOnDashboardPage />} />
            <Route path="/aibhive-on/settings" element={<AibhiveOnSettingsPage />} />
            <Route path="/aibhive-on/download" element={<AibhiveOnDownloadPage />} />
            ...
            <Route path="/solutions/ai-safety-compliance" element={<Navigate to="/" replace />} />
            <Route path="/solutions/ai-development-safety" element={<Navigate to="/ai-development-services" replace />} />
            <Route path="/solutions/ai-hiring-services-safety" element={<Navigate to="/book-consultation" replace />} />
            <Route path="/solutions/ai-agents-platform-safety" element={<Navigate to="/tools/for-ai-agents" replace />} />
            <Route path="/ai-development-services" element={<AiDevelopmentServicesPage />} />
            <Route path="/legal/search-ai-conduct-enforcement" element={<Navigate to="/privacy-policy.html" replace />} />
            <Route path="/ai-development-service" element={<Navigate to="/ai-development-services" replace />} />
            ...
            <Route path="/app" element={<AppLayout />}>
              ...
              <Route path="research/academy" element={<ResearchPage />} />
            ...
            <Route path="/plants/autoimmune" element={<AutoimmunePage />} />
...
function AppShell() {
  ...
  const isHelloRoute = pathname === '/hello';
  const isEmbedRoute =
    pathname.startsWith('/hive-apps/embed') ||
    pathname.startsWith('/embed/green-team') ||
    pathname.startsWith('/embed/bug-bounties') ||
    pathname.startsWith('/embed/ai-money') ||
    pathname.startsWith('/greenteam-embed/') ||
    isHelloRoute;
  const isPlantsMobileShell = pathname.startsWith('/plants') && isPlantsMobileApp();
  const isPlantsRoute = pathname.startsWith('/plants');
  const isResearchOs =
    pathname === '/research-lab' || pathname.startsWith('/research-lab/workspace');
  const hideSiteAssistant = pathname.startsWith('/plants') || isResearchOs || isOnlyFansRoute;
  const hideFooter =
  ...
  return (
    <AssistantDockProvider>
      <div className="min-h-screen flex flex-col honeycomb-pattern selection:bg-bee-amber selection:text-bee-black">
        {!isPrivateRoute && !isEmbedRoute && !isProsPublicRoute && !isDiagnosePublicRoute && !isPlantsRoute && !isResearchOs && !isOnlyFansRoute && (
        ...
        <main
          className={`flex-grow ${isEmbedRoute || isProsPublicRoute || isDiagnosePublicRoute || isPlantsRoute || isResearchOs || isOnlyFansRoute ? '' : 'pt-20'} ${hideFooter || isResearchOs ? 'pb-0' : ''}`}
        >
          {isPrivateRoute ? (
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route path="/diagnose/app" element={<DiagnoseWebLayout />}>
                  ...
                  <Route path="tools/construction" element={<DiagnoseWebConstructionChart />} />
