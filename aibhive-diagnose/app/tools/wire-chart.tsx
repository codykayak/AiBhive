  ...
  return (
    <ScrollView className="flex-1 bg-hive-bg" contentContainerStyle={{ padding: 20, paddingBottom: 48 }}>
      ...
      {COMMON_TORQUE.map((row) => (
        <View key={row.item} className="mb-2 rounded-sm border border-hive-border bg-hive-elevated px-4 py-3">
      ...
      {CODE_QUICK_REFS.map((ref) => (
        <View key={ref.id} className="mb-3 rounded-sm border border-hive-border bg-hive-elevated px-4 py-4">
